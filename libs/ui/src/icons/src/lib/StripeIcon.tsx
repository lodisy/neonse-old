...
export const StripeIcon = ({ width = 150, height }: Props) => {
    return (
		...
		c2.6-2.9,6.2-4.9,11.9-4.9c9.1,0,15.4,10.2,15.4,23.3C310.5,126.5,304.3,136.5,295.1,136.5z"
            />
            <StyledPolygon points="223.8,61.7 248.9,56.3 248.9,36 223.8,41.3" />
            <StyledRect x="223.8" y="69.3" width="25.1" height="87.5" />
            <StyledPath d="M196.9,76.7l-1.6-7.4h-21.6v87.5h25V97.5c5.9-7.7,15.9-6.3,19-5.2v-23C214.5,68.1,202.8,65.9,196.9,76.7z" />
            <StyledPath
