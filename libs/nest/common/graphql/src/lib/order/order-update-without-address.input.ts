...
import { OrderItemUpdateManyWithoutOrderInput } from '../order-item/order-item-update-many-without-order.input';
import { PaymentUpdateOneWithoutOrderInput } from '../payment/payment-update-one-without-order.input';

@InputType()
export class OrderUpdateWithoutAddressInput {
    ...
    @Field(() => OrderItemUpdateManyWithoutOrderInput, {nullable:true})
