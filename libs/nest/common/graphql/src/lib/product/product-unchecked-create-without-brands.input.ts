...
import { ProductTranslationUncheckedCreateNestedManyWithoutProductInput } from '../product-translation/product-translation-unchecked-create-nested-many-without-product.input';

@InputType()
export class ProductUncheckedCreateWithoutBrandsInput {
    ...
    @Field(() => ProductTranslationUncheckedCreateNestedManyWithoutProductInput, {nullable:true})
