...
import { FileUpdateOneRequiredWithoutOrderItemInput } from '../file/file-update-one-required-without-order-item.input';
import { OrderUpdateOneWithoutItemsInput } from '../order/order-update-one-without-items.input';
...
export class OrderItemUpdateInput {
    ...
    @Field(() => FileUpdateOneRequiredWithoutOrderItemInput, {nullable:true})
    image?: FileUpdateOneRequiredWithoutOrderItemInput;

    @Field(() => OrderUpdateOneWithoutItemsInput, {nullable:true})
