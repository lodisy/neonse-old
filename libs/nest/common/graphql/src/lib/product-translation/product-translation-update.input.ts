...
import { ProductUpdateOneWithoutTranslationsInput } from '../product/product-update-one-without-translations.input';

@InputType()
export class ProductTranslationUpdateInput {
    ...
    @Field(() => ProductUpdateOneWithoutTranslationsInput, {nullable:true})
    product?: ProductUpdateOneWithoutTranslationsInput;
}
