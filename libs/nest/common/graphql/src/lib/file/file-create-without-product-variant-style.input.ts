...
import { OrderItemCreateNestedManyWithoutImageInput } from '../order-item/order-item-create-nested-many-without-image.input';
...
@InputType()
export class FileCreateWithoutProductVariantStyleInput {
    ...
    @Field(() => OrderItemCreateNestedManyWithoutImageInput, {nullable:true})
