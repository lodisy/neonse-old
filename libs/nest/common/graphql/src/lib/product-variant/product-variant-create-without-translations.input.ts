...
import { ProductVariantSizeCreateNestedOneWithoutProductVariantInput } from '../product-variant-size/product-variant-size-create-nested-one-without-product-variant.input';
...
@InputType()
export class ProductVariantCreateWithoutTranslationsInput {
    ...
    @Field(() => ProductVariantSizeCreateNestedOneWithoutProductVariantInput, {nullable:true})
