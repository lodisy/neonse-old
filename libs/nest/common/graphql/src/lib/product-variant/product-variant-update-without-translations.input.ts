...
import { ProductVariantSizeUpdateOneWithoutProductVariantInput } from '../product-variant-size/product-variant-size-update-one-without-product-variant.input';
...
@InputType()
export class ProductVariantUpdateWithoutTranslationsInput {
    ...
    @Field(() => ProductVariantSizeUpdateOneWithoutProductVariantInput, {nullable:true})
