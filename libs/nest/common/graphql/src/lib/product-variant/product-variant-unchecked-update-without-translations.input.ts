...
import { ProductVariantSizeUncheckedUpdateOneWithoutProductVariantInput } from '../product-variant-size/product-variant-size-unchecked-update-one-without-product-variant.input';
...
@InputType()
export class ProductVariantUncheckedUpdateWithoutTranslationsInput {
    ...
    @Field(() => ProductVariantSizeUncheckedUpdateOneWithoutProductVariantInput, {nullable:true})
    size?: ProductVariantSizeUncheckedUpdateOneWithoutProductVariantInput;
