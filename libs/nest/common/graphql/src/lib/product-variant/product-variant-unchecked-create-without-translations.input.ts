...
import { ProductVariantColorUncheckedCreateNestedOneWithoutProductVariantInput } from '../product-variant-color/product-variant-color-unchecked-create-nested-one-without-product-variant.input';
...
@InputType()
export class ProductVariantUncheckedCreateWithoutTranslationsInput {
    ...
    @Field(() => ProductVariantColorUncheckedCreateNestedOneWithoutProductVariantInput, {nullable:true})
    color?: ProductVariantColorUncheckedCreateNestedOneWithoutProductVariantInput;
