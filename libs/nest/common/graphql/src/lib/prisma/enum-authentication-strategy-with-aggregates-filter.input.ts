...
import { NestedEnumAuthenticationStrategyWithAggregatesFilter } from './nested-enum-authentication-strategy-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAuthenticationStrategyFilter } from './nested-enum-authentication-strategy-filter.input';

@InputType()
export class EnumAuthenticationStrategyWithAggregatesFilter {
